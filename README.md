...
Bloc homogène. Notions manipulées :
...
Calculs de moyennes, max, totaux, comptages.
...
**Fonctions annexes**
`countDocuments()`, `distinct()`, opérateurs de pipeline modernes : `$count` interne au groupe.

**Mises à jour**
`updateOne`, `updateMany`, opérateurs : `$set`, `$unset`.
...
**Indexation**
Index simples, composés, texte, multikey, unique, TTL, partiel, sparse, collation.
